...
dependencies {
    // Vert.x launcher application (from pom.xml)
    api("io.vertx:vertx-launcher-application:$vertxVersion")

    // Keel dependencies (from pom.xml)
    api("io.github.sinri:keel-core:$keelCoreVersion")
    api("io.github.sinri:keel-mysql:$keelMySQLVersion")
    api("io.github.sinri:keel-web:$keelWebVersion")
    api("io.github.sinri:keel-aliyun:$keelAliyunVersion")
    api("io.github.sinri:keel-logger-ext:$keelLoggerExtVersion")
...
tasks.test {
    useJUnitPlatform()
    include("io/github/sinri/keel/app/**/*UnitTest.class")
}
